...
\subsection{proc. generarJoin}
    \subsubsection{Especificaci\'on:}
        \begin{proc}{generarJoin}{\In th: $eph_{h}$, \In ti : $eph_{i}$, \Out junta:  $joinHI$}{}
            ...
            \post{|junta| = |ti|\ \y\ sonDuplasValidas(th,\ ti,\ junta)}
        \end{proc}
        % === Requisitos === %
    ...
    \subsubsection{Predicados y funciones auxiliares:}
        ...
        \noindent\pred{sonDuplasValidas}{th: $eph_{h}$, ti: $eph_{i}$, junta: $joinHI$}{\\
            ...
            \tab hogaresEnDuplaValidos(th,\ junta)\ \y\\
    ...
    \subsubsection{Observaciones:}
        \begin{itemize}
            ...
            \item el predicado $hogaresEnDuplaValidos$ comprueba que todos los hogares en la $junta$ provengan de $th$. 
            Admite el caso en el que se repiten, cuando $|ti| > |th|$.  
        \end{itemize}
