...
\subsection{proc. histHabitacional}
    ...
    \subsubsection{Especificaci\'on:}
        ...
        % CORREGIR
        \post{\\
            \textcolor{green}{HayMaximoDeHabitaciones(th, res)}\ \y \\
    ...
    % CORREGIR
    \textcolor{green}{
        \noindent \pred{HayMaximoDeHabitaciones}{th : $eph_{h}$, res: \Tlista{\ent}}{\\
            \tab(\exists h \in hogar)(h \in th \y (\forall i \in \ent)(0 \leq i \leq \longitud th -1 \y h[@iv2] \geq th[i][@iv2]) \y h[@iv2]=\longitud res}\\
        }
    }
    \textcolor{red}{
