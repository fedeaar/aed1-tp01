...
\begin{document}
    ...
    % === caratula === % 
    %\titulo{TP1 - especificacion}
    %\subtitulo{}
    %\fecha{septiembre 2021}
    %\materia{algoritmos y estructuras de datos 1}
    %\integrante{Manuel Lakowsky}{511/21}{mlakowsky@gmail.com}
    %\integrante{Juan Manuel Lenardi}{}{}
    %\integrante{Federico Arienti}{316/2}{fa.arienti@gmail.com}
    %\maketitle
    \begin{titlepage}
        \vspace*{\fill}
        \begin{center}
        ...
        \subsection{proc. creceElTeleworkingEnCiudadesGrandes}
            \begin{proc}{creceElTeleworkingEnCiudadesGrandes}{\In t1h: $eph_{h}$, \In t1i: $eph_{i}$, \In t2h: $eph_{h}$, \In t2i: $eph_{i}$, \Out res: Bool}{}
                \pre{\\
                    ...
                    \tab t1h[0][@hogtrimestre] = t2h[0][@hogtrimestre]\\
                }
                \post{\\
                    \tab res = \True \iff percentTeleworking(t1h,t1i) < percentTeleworking(t2h,t2i) \\
                }
            \end{proc}
