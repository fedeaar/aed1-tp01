...
\begin{document}
    ...
    \section{funciones generales}
        ...
        $\comment{\tab}{indiceHogarPorCodusu asume codusu$_{h}$ existe en la tabla}$
        ...
        \subsection{proc. creceElTeleworkingEnCiudadesGrandes}
            ...
            \begin{proc}{creceElTeleworkingEnCiudadesGrandes}
                ...
                \pre{\\
                    ...
                    \tab t1h[0][@hogtrimestre] = t2h[0][@hogtrimestre] \y \\
            ...
            \subsubsection{funciones auxiliares}
                ...
                \pred{viveEnHogarValido}{th: $eph_{h}$, p: $individuo$}{
                    ...
                    esHogarValidoParaTeleworking(th, \ indiceHogarPorCodusu(th, \ p[@indcodusu]))
                }
                $\newline$
