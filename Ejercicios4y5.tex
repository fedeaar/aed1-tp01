...
\post{res = percentTeleworking(t1h,t1i) < percentTeleworking(t2h,t2i)}
\end{proc}
...
\pred{filtroSubsidio}{ti: eph_i, thr: hogar}{
    (thr[@ii7] = 1) \y\\
    individuosEnHogar(thr[@hogcodusu]) - 2 > thr[@ii2]
}
