...
TEST(quitarIndividuosTEST, SacaTodosMenosUno) {
    ...
    eph_i ti = {
            {22010,2020,1,0,3,1,65,1,2,15000,8},
            {22010,2020,7,0,3,2,22,0,0,10000,10},
            {22010,2020,9,0,3,1,9,0,0,15000,10},
            {22010,2020,10,0,3,2,9,0,0,15000,10},
            {22010,2020,11,0,3,2,2,0,0,15000,10},
            {22010,2020,12,0,3,2,17,0,0,15000,10},
            {20101,2020,1,0,3,2,46,1,3,15000,0},
            {20101,2020,2,0,3,1,24,0,3,6000,10},
    };
...
TEST(quitarIndividuosTEST, vacia) {
    ...
    eph_i ti = {
            {22010,2020,1,0,3,1,65,1,2,15000,8},
            {22010,2020,7,0,3,2,22,0,0,15000,10},
            {22010,2020,9,0,3,1,9,0,0,15000,10},
            {22010,2020,10,0,3,2,9,0,0,15000,10},
            {22010,2020,11,0,3,2,2,0,0,15000,10},
            {22010,2020,12,0,3,2,17,0,0,15000,10},
            {20101,2020,1,0,3,2,46,1,3,15000,0},
            {20101,2020,2,0,3,1,24,0,3,15000,10},
    };
