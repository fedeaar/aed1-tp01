...
\subsection{proc. quitarIndividuos}
    ...
    \subsubsection{Observaciones:}
        \begin{itemize}
            ...
            $attEnRango$ definidos en 1.1.2., porque -para el alcanze de este TPE- consideramos que complejizaría 
            la lectura de ambas especificaciones en mayor grado de lo que les aportaría.
        \end{itemize}